...
Route::get('/', [UserBookingController::class, 'home'])
    ->name('home');
...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    Route::middleware('role:user')
        ...
        ->group(function () {
            ...
            Route::post(
                '/bookings/{booking}/pdf',
                [UserBookingController::class, 'downloadPdf']
            )->name('bookings.pdf');
        });
    ...
    */
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::get(
            '/reports/reservations/print',
            [ReportController::class, 'print']
        )->name('reports.reservations.print');

        Route::get(
            '/reports/reservations/excel',
            [ReportController::class, 'printExcel']
