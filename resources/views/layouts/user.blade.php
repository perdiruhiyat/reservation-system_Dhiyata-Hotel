    ...
    <style>
        ...
        * {
        ...
        .hero {
            ...
            color: #fff;
            background:
                linear-gradient(135deg, rgba(15, 118, 110, .94), rgba(13, 148, 136, .78)),
...
<body>
    <nav class="navbar navbar-expand-lg sticky-top no-print">
        <div class="container py-2">
            <a class="navbar-brand fw-bold d-flex align-items-center gap-2" href="{{ route('user.home') }}">
                <span class="brand-logo"><i class="bi bi-buildings-fill"></i></span>
            ...
            <div class="collapse navbar-collapse" id="userNav">
                <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('user.bookings.index') || request()->routeIs('user.bookings.show') ? 'active' : '' }}"
                            href="{{ route('user.bookings.index') }}">Reservasi Saya</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-primary" href="{{ route('user.bookings.create') }}">
                            <i class="bi bi-calendar2-plus me-1"></i>Pesan Kamar
                        </a>
                    </li>
    ...
    <footer class="user-footer no-print">
        <div class="container d-flex flex-wrap justify-content-between gap-2">
            <div class="fw-bold text-dark">Dhiyata Hotel</div>
            <div class="small">Reservasi nyaman, proses lebih praktis.</div>
        </div>
    </footer>
